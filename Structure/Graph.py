...
class Graph:
    ...
    INITIAL_MATRIX_SIZE_PROBLEM_1 = (15, 3)
    INITIAL_MATRIX_SIZE_PROBLEM_2 = (10, 4)

    def __init__(self, grid=None, number_problem=0):
        self.nodes = {}
        if number_problem == 1:
            self.matrix_size = Graph.INITIAL_MATRIX_SIZE_PROBLEM_1
        elif number_problem == 2:
            self.matrix_size = Graph.INITIAL_MATRIX_SIZE_PROBLEM_2
        else:
            raise ValueError("Número de problema no válido. Debe ser 1 o 2.")
